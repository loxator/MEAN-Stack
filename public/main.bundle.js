...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_flash_messages___ = __webpack_require__("./node_modules/angular2-flash-messages/module/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_angular2_flash_messages____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_angular2_flash_messages___);
...
var appRoutes = [
    ...
    { path: 'dashboard', component: __WEBPACK_IMPORTED_MODULE_14__components_dashboard_dashboard_component__["a" /* DashboardComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_15__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_8_angular2_flash_messages___["FlashMessagesModule"].forRoot(),
                __WEBPACK_IMPORTED_MODULE_3__angular_http__["HttpModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClientModule */],
                __WEBPACK_IMPORTED_MODULE_5__angular_router__["b" /* RouterModule */].forRoot(appRoutes)
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_6__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_7__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */]],
...
module.exports = "<div *ngIf=\"user\">\n\n<h2 class=\"page-header\">{{user.name}}'s Dashboard!</h2>\n\n<p>Welcome {{user.name}}</p>\n</div>\n"
...
module.exports = "<div class=\"jumbotron text-center\">\n\n    <h1>MEAN AUTHENTICATION APP</h1>\n    <p>Welcome to our custom MEAN Authentiaction App!</p>\n    <div>\n      <a class=\"btn btn-primary\" [routerLink] = \"['/register']\">Register</a>\n      <a class=\"btn btn-primary\" [routerLink] = \"['/login']\">Login</a>\n    </div>\n\n  <div class=\"row\">\n    <div class=\"col-md-4\">\n      <h3>Express Backend</h3>\n      <p>Express server!</p>\n    </div>\n\n    <div class=\"col-md-4\">\n      <h3>Angular CLI</h3>\n      <p>Angular Front end</p>\n    </div>\n\n    <div class=\"col-md-4\">\n      <h3>JWT Tokens</h3>\n      <p>Full fledged authentication</p>\n    </div>\n\n  </div>\n\n</div>\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, router, flashMesage) {
        this.authService = authService;
        this.router = router;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMesage.show('You are now logged in'), { cssClass: 'alert-success', timeout: 5000 };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(authService, router, flashMesage) {
        this.authService = authService;
        this.router = router;
        this.flashMesage = flashMesage;
    }
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('Not registered, please try again later', { cssClass: 'alert-danger', timeout: 3000 });
